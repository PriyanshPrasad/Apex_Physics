  ...
  // ---- RC10: limit behavior expert ----
  {
    ...
    gen: (r): RawQ => {
      ...
      return {
        ...
        tempt: [
          undefined,
          "The DESTINATION (Q = CV) never depended on R — only the journey did. Kill R and the journey takes zero time.",
          "The capacitor still charges — the battery still pumps charge until V_C = ε.",
          "Nothing dissipates energy, but the battery's work still stores ½CV² on the capacitor.",
